        ...
        <div>
          ...
          <p className="mt-4 text-xl font-semibold">
            {product.name === 'Pet Prata' &&
              'Alcance potencial de 6.000 a 10.000 pessoas'}
            {product.name === 'Pet Bronze' &&
              'Alcance potencial de 10.000 a 20.000 pessoas'}
            {product.name === 'Pet Ouro' &&
              'Alcance potencial de 20.000 a 50.000 pessoas'}
          </p>
          ...
          <ul className="list-disc ml-5 mt-3">
            <li>
              Gerenciamento e veiculação do alerta(Propaganda) geolocalizada
            </li>

            <li>
              Panfleto personalizado com QR Code direcionando para WhatsApp do
              Tutor
            </li>
            ...
            <li>
              Envio de relatório de visualizações e pessoas alcançadas
              diariamente
            </li>
            ...
            <li>
              {product.name === 'Pet Prata' &&
                'Propaganda geolocalizada com Duração 7 dias'}
              {product.name === 'Pet Bronze' &&
                'Propaganda geolocalizada com Duração 14 dias'}
              {product.name === 'Pet Ouro' &&
                'Propaganda geolocalizada com Duração 30 dias'}
            </li>
          </ul>
          ...
          <p className="mt-4">
            ...
            <br />
            <ins className="text-[#1ab794] text-4xl font-bold no-underline">
              {product.price}
            </ins>
          </p>
