...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="bg-[#fff5ed] bg-[url('../assets/footer-bg.png')] bg-cover bg-center bg-no-repeat"
    >
          ...
          <div className="w-11/12 sm:w-3/12 flex justify-content-sm-start justify-content-start">
            <div className="footer-items contact">
              ...
              <div className="flex items-center mb-7">
                ...
                <div>
                  <h6>
                    <a href="mailto:contato@alertapet.com">
                      contato@alertapet.com
                    </a>
                  </h6>
                </div>
              </div>
          ...
          <div className="w-11/12 sm:w-6/12 flex items-center justify-center">
            <div>
              <h2 className="text-5xl text-center font-normal">
                ...
                de encontrar
                <br /> <span className="font-bold">seu melhor amigo</span>!
              </h2>
            ...
            <div className="text-center">
              <p className="flex justify-center items-center">
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="mx-1 w-4 h-4 text-red-600"
                >
                  <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" />
                </svg>
                por{' '}
                <a
                  href="https://www.instagram.com/sweetspotmidia/"
