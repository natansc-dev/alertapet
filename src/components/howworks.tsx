...
export default function HowWorks() {
  return (
    <div
      id="por-que-a-alerta-pet"
      className="bg-[url('../assets/feature-bg.png')] py-32 bg-no-repeat bg-cover text-white"
    >
      <div className="w-full p-0">
        <div className="flex flex-wrap gap-6 justify-center w-11/12 mx-auto items-center">
          <div className="mb-7">
            <h2 className="font-bold text-5xl sm:text-left text-center ">
              Como que isso
              <br />
              funciona?
            </h2>
          ...
          <div className="gap-4 flex flex-col sm:flex-row items-center justify-center">
            <div className="max-w-xs rounded-lg">
              ...
              <div className="content">
                ...
                <p className="text-lg">
                  Selecione o plano que mais atende as suas necessidades.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-xs  rounded-lg">
              ...
              <div className="content">
                ...
                <p className="text-lg">
                  Coletamos o máximo de informações sobre seu Pet e o local que
                  ele desapareceu.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-xs rounded-lg">
              ...
              <div className="content">
                ...
                <p className="text-lg">
                  Iniciamos os anuncios notificando o desaparecimento o mais
                  rapido possivel
                </p>
              </div>
            </div>
